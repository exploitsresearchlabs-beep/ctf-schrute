...
// Level information for the landing page
const levels = [
    { id: 0, name: 'The Receptionist', icon: '📞', difficulty: 'Easy' },
    { id: 1, name: 'The Assistant', icon: '📋', difficulty: 'Easy' },
    { id: 2, name: 'The Simulation', icon: '🎮', difficulty: 'Medium' },
    { id: 3, name: 'The Liar', icon: '🤥', difficulty: 'Medium' },
    { id: 4, name: 'The Encoder', icon: '🔐', difficulty: 'Medium' },
    { id: 5, name: 'The Database', icon: '💾', difficulty: 'Hard' },
    { id: 6, name: 'The Compliance Officer', icon: '📊', difficulty: 'Hard' },
]
    ...
    return (
        <div className="container mx-auto px-4 py-12">
            ...
            <section className="text-center mb-16 animate-fade-in">
                ...
                <h1 className="text-5xl md:text-7xl font-bold mb-4 bg-gradient-to-r from-schrute-beet via-red-500 to-schrute-gold bg-clip-text text-transparent">
                    Schrute CTF
                </h1>
